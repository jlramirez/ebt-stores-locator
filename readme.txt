=== EBT Stores Locator ===
Contributors: jramirez001
Tags: ebt, stores, maps, services, pages, posts, shortcode
...
Add a map into your posts and/or pages of available EBT Stores using shortcode.

== Description ==

EBT Stores Locator allows you to easily embed a map of stores that accept EBT (Electronic Benefits Transfer) cards in any Wordpress post or page by using shortcode. 
...
[ArcGIS](https://www.arcgis.com/features/maps/index.html) to include basemaps.
